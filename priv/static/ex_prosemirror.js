var LiveView = (() => {
  ...
  // js/ExEditorView.js
  var import_prosemirror_model4 = __toModule(__require("prosemirror-model"));
  var import_prosemirror_state5 = __toModule(__require("prosemirror-state"));
  var import_prosemirror_view2 = __toModule(__require("prosemirror-view"));

  // js/prosemirror/plugins/placeholder.js
  var import_prosemirror_state = __toModule(__require("prosemirror-state"));
  var import_prosemirror_view = __toModule(__require("prosemirror-view"));
  ...
  var import_prosemirror_model3 = __toModule(__require("prosemirror-model"));

  // js/prosemirror/marks/index.js
  var import_prosemirror_schema_basic = __toModule(__require("prosemirror-schema-basic"));
  ...
  var import_prosemirror_model = __toModule(__require("prosemirror-model"));
  var lower16 = 65535;
  ...
  var import_prosemirror_model2 = __toModule(__require("prosemirror-model"));
  var import_prosemirror_state2 = __toModule(__require("prosemirror-state"));
  ...
  var import_prosemirror_state3 = __toModule(__require("prosemirror-state"));
  ...
  var import_prosemirror_state4 = __toModule(__require("prosemirror-state"));
  ...
  var import_prosemirror_schema_basic2 = __toModule(__require("prosemirror-schema-basic"));
  ...
  // js/hooks/index.js
  var import_prosemirror_example_setup = __toModule(__require("prosemirror-example-setup"));
  ...
  var import_prosemirror_state6 = __toModule(__require("prosemirror-state"));
